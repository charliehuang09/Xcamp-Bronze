...
//    if (index == length1){
//        combinations1.push_back(sum % target);
//        return;
//    }
//    get_combinations1(input, sum, index + 1);
//    get_combinations1(input, (sum + input[index]) % target, index + 1);
//}
//void get_combinations2(int input[], int sum, int index){
//    if (index == length2){
//        combinations2.push_back(sum % target);
//        return;
//    }
//    get_combinations2(input, sum, index + 1);
//    get_combinations2(input, (sum + input[index]) % target, index + 1);
//}
//
//int main(){
...
//        auto it = prev(lower_bound(combinations1.begin(), combinations1.end(), target - combinations2[i] - 1));
//        it += binary_search(combinations1.begin(), combinations1.end(), target - combinations2[i] - 1);
